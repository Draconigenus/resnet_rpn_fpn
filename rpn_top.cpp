...
)
{
   ...
   std::cout << "Begin processing RPN Anchor Gen 4..." << std::endl;
    ...
    // bool flag4[RPN_CLS_OUT_CH*RPN_INPUT4_IN_FM_HEIGHT*RPN_INPUT4_IN_FM_WIDTH]={false};
    // for(int i = 0; i<RPN_PRE_NMS_SIZE4; i++)
    // {
    //     fm_t maximum_score = 0.0;
    //     int index = -1;
    //     for(int j = 0; j<RPN_CLS_OUT_CH*RPN_INPUT4_IN_FM_HEIGHT*RPN_INPUT4_IN_FM_WIDTH; j++)
    //     {
    //         if(flag4[j] == true)    continue;
    //         if(rpn_anchor4_cls_fm[j]>maximum_score)
    //         {
    //             maximum_score = rpn_anchor4_cls_fm[j];
    //             index = j;
    //         }
            
    //     }
    //         rpn_topk_index4[i]=index;
    //         flag4[index]=true;
    // }
    ...
    // for(int i = 0; i<RPN_PRE_NMS_SIZE; i++) cout<<nms_flag[i]<<endl;
    int ind = 0;
